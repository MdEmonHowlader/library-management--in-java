...
public class Databace {
   ...
   private File userfile =new File(Main.class.getClassLoader().getResource("date\\Users").getFile());
    private File booksfile =new File(Main.class.getClassLoader().getResource("date\\Books").getFile());
